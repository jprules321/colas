...
B<fish_chi>(I<UEXPR,VEXPR[,MBDCND]>0 - Computes Velocity Potential
...
B<fish_div>(I<UEXPR,VEXPR[,MBDCND]>0 - Computes Divergence 
...
=head2 B<fish_vor>(I<UEXPR,VEXPR[,MBDCND]>0 - Computes Relative Vorticity
...
=head2  B<fish_div>(I<UEXPR,VEXPR[,MBDCND]>0 - Computes Divergence 
